...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('h1.style1, h2.style1, h3.style1, p.style1', { style: 'blur-in', speed: 1000, intensity: 5, delay: 0, staggerOrder: '', replay: false });
		onvisible.add('h1.style2, h2.style2, h3.style2, p.style2', { style: 'zoom-in', speed: 1000, intensity: 5, delay: 125, staggerOrder: '', replay: false });
		onvisible.add('.buttons.style1', { style: 'zoom-out', speed: 1000, intensity: 0, delay: 125, stagger: 125, replay: false });
		onvisible.add('#container02', { style: 'blur-in', speed: 1000, intensity: 5, delay: 0, staggerOrder: '', replay: true });
